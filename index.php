...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-right" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="datewise_report.php" class="list-group-item list-group-item-action "><span data-feather="calendar"></span> Datewise Report</a>
            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title text-center">Expense Category (Pie Chart)</h5>
                            </div>
                            <div class="card-body">
                                <canvas id="expense_category_pie_chart" height="150"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        var ctxPie = document.getElementById('expense_category_pie_chart').getContext('2d');
